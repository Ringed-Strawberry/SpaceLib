...
public class ItemGen {
    public static Item createItem(ResourceLocation id, Function<Item.Properties, Item> factory, Item.Properties settings) {
    ...
    private static ResourceKey<Item> keyOf(ResourceLocation id) {
