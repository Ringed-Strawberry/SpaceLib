...
public class BlockGen {
    ...
    public static ResourceKey<Item> itemKeyOf(ResourceLocation id) {
        return ResourceKey.create(Registries.ITEM, id);
    }

    public static Block createBlock(Function<BlockBehaviour.Properties, Block> factory, ResourceLocation id, BlockBehaviour.Properties settings) {
